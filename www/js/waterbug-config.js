...
var logos = {
    'cpr': {
        whitePath: '../img/icon-cpr-white.png', // path to white logo
        blackPath: '../img/icon-cpr-black.png', // path to black logo
        w: 150, // width of logo
        h: 74, // height of logo
        display: 'CPR'
    },
    'cpr_news': {
        whitePath: '../img/icon-cpr-news-white.png',
        blackPath: '../img/icon-cpr-news-black.png',
        w: 150,
        h: 115,
        display: 'CPR News'
    }
...
var fontFace = "Montserrat, Helvetica, Arial"; // font family for credit
...
var currentLogo = 'cpr'; // default logo slug
